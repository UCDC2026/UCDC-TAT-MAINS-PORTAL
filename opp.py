...
# -----------------------------------------------------
# ૩. પ્રશ્નો લોડ કરવા (નવો ઓપ્શન ઉમેર્યો છે)
# -----------------------------------------------------
    ...
    if st.button("પેપર ચેક કરો 🚀"):
        ...
        if not student_name or not has_patel:
            ...
            with st.spinner("⏳ પેપરનું ડીપ ચેકિંગ ચાલુ છે..."):
                try:
                    # ડાયનેમિક કેટેગરી રૂલ્સ અને માર્કિંગ સિસ્ટમ (તમારા અને મારા માપદંડોનું પરફેક્ટ મિશ્રણ)
                    if category == "સંપૂર્ણ પેપર (૧૦૦ ગુણ)":
                        total_marks = 100
                        max_marks_allowed = "લાગુ પડતું નથી (દરેક વિભાગની લિમિટ મુજબ ગણતરી કરવી)"
                        expected_words = "દરેક વિભાગની માંગ મુજબ"
                        category_rules = """
                        ✅ **ખાસ સૂચના (સંપૂર્ણ પેપર માટે):** વિદ્યાર્થીએ આખું 100 માર્કનું પેપર અપલોડ કર્યું છે. તમારે દરેક પ્રશ્ન શોધીને તેનું અલગ-અલગ મૂલ્યાંકન નીચે મુજબના કડક માપદંડોથી કરવાનું છે:
                        ૧. નિબંધ (૨૦ ગુણ): ૨૫૦-૩૦૦ શબ્દો. મહત્તમ ૧૪ ગુણ. હકારાત્મક: પ્રસ્તાવના/ઉપસંહાર(૪), વિષયવસ્તુ(૮), મૌલિકતા(૪), ભાષા(૪). નકારાત્મક: વિષયાંતર(-૩ થી -૫), શબ્દમર્યાદા ભંગ(-૨).
                        ૨. ચર્ચાપત્ર (૨ પ્રશ્નો, કુલ ૨૦ ગુણ): દરેકના ૨૦૦ શબ્દો. પ્રત્યેકમાં મહત્તમ ૬ ગુણ જ આપવા. હકારાત્મક: ફોર્મેટ(૨), તટસ્થ રજૂઆત(૩), સૂચનો(૩), ભાષા(૨). નકારાત્મક: ફોર્મેટ ભૂલ(-૧ પ્રતિ ભૂલ).
                        ૩. પત્ર લેખન (૨ પ્રશ્નો, કુલ ૨૦ ગુણ): દરેકના ૧૫૦-૨૦૦ શબ્દો. પ્રત્યેકમાં મહત્તમ ૬ ગુણ જ આપવા. હકારાત્મક: ફોર્મેટ(૩), સચોટતા(૪), સત્તાવાર ભાષા(૩). નકારાત્મક: સાચું નામ/સરનામું લખે તો સીધા (-૨).
                        ૪. સંક્ષેપીકરણ (૨ પ્રશ્નો, કુલ ૨૦ ગુણ): ૧/૩ ભાગ. પ્રત્યેકમાં મહત્તમ ૫ ગુણ જ આપવા. હકારાત્મક: શીર્ષક(૨), મૂળ વિચાર(૩), મૌલિકતા(૩), લંબાઈ(૨). નકારાત્મક: શીર્ષક વગર(-૨), કોપી-પેસ્ટ(-૩).
                        ૫. વ્યાકરણ (૨૦ ગુણ): દરેક સાચા જવાબનો ૧ ગુણ, સહેજ પણ ભૂલ હોય તો સીધો ૦ ગુણ. અડધો ગુણ આપવો જ નહીં.
                        
                        📌 મૂલ્યાંકન ટેબલમાં આ પાંચેય વિભાગોનું અલગ-અલગ લિસ્ટ બનાવીને કુલ ૧૦૦ માંથી મેળવેલ ગુણની એક સંપૂર્ણ માર્કશીટ (Grand Total) બનાવવી.
                        """
                    elif category == "નિબંધ લેખન":
                        total_marks = 20
                        max_marks_allowed = 14
                        expected_words = "૨૫૦ થી ૩૦૦ શબ્દો"
                        category_rules = """
                        ...
                        total_marks = 10
                        max_marks_allowed = 6
                        expected_words = "૧૫૦ થી ૨૦૦ શબ્દો"
                        category_rules = """
                        ...
                        total_marks = 10
                        max_marks_allowed = 5
                        expected_words = "મૂળ ફકરાનો બરાબર ૧/૩ (ત્રીજો) ભાગ"
                        category_rules = """
                        ...
                        category_rules = """
                        ✅ નિયમ: વ્યાકરણના કુલ ૨૦ પ્રશ્નો પૂછાયા હશે. દરેક પ્રશ્નનો ૧ ગુણ છે. (કુલ ૨૦ ગુણ).
                        ...
                        📌 ખાસ સૂચના: મૂલ્યાંકન ટેબલમાં ૧ થી ૨૦ પ્રશ્નોનું લિસ્ટ બનાવવું અને દરેક પ્રશ્નની સામે તેણે મેળવેલ ૧ અથવા ૦ ગુણ દર્શાવવા અને અંતે કુલ સરવાળો કરવો.
                        """
                    ...
                    - સૌથી કડક નિયમ: ગમે તેટલો સારો જવાબ હોય, પણ દર્શાવેલ મહત્તમ લિમિટ ({max_marks_allowed}) થી વધુ ગુણ આપવા જ નહીં.

                    {category_rules}

                    ⚠️ સાર્વત્રિક નકારાત્મક માર્કિંગ (Negative Marking):
                    ...
                    (શબ્દો ગણીને જણાવો. સંપૂર્ણ પેપર હોય તો વિભાગ મુજબ એનાલિસિસ આપો.)

                    ### ૨. ક્યાં માર્કસ કપાયા અને શા માટે? (Errors & Marking Analysis): 
                    (ઉપરના નિયમો મુજબ કયા માપદંડમાં ભૂલ થઈ છે અને શા માટે માર્ક કપાયા છે તે સ્પષ્ટ જણાવો.)

                    ### ૩. વિભાગવાર માર્કિંગ અને મેળવેલ ગુણ (Out of {total_marks}): 
                    (એક સુંદર ટેબલ બનાવો. જો સંપૂર્ણ પેપર હોય તો 100 માર્કની ડીટેઈલ માર્કશીટ બનાવવી.)

                    ### ૪. ભૂલોનું લિસ્ટ (સચોટ ચેકિંગ): 
                    (જોડણી, વાક્યરચના, વિરામચિહ્નો અને ફોર્મેટની તમામ ભૂલો અહીં પોઈન્ટ્સમાં દર્શાવો.)

                    ### ૫. વિસ્તૃત સલાહ અને માર્ગદર્શન (Expert Advice): 
                    (અહીં અત્યંત ડીપમાં અને વિગતવાર માર્ગદર્શન આપો. 
                    ફરજિયાત આ વાક્યનો પ્રયોગ કરો: "જો તમે આવું લખ્યું હોત અને આ [X, Y, Z] મુદ્દાઓ કે ઉદાહરણો ઉમેર્યા હોત, તો તમારા માર્ક ચોક્કસ વધારે આવત." 
                    નોંધ: કોઈ ચોક્કસ આંકડો આપવો નહીં કે 'આટલા માર્ક આવત'. સંદર્ભ માટે માત્ર GCERT, ગ્રંથ નિર્માણ બોર્ડ કે 'ગુજરાત પાક્ષિક' જ સૂચવવા.)
                    """
