        ...
        if not student_name or not has_patel:
            ...
            with st.spinner("⏳ પેપરનું ડીપ ચેકિંગ ચાલુ છે..."):
                try:
                    ...
                    (આ વિભાગ સૌથી મહત્વનો છે. અહીં વિદ્યાર્થીને અત્યંત વિસ્તૃત અને મુદ્દાસર માર્ગદર્શન આપો. તેને સમજાવો કે આ જવાબને વધુ શ્રેષ્ઠ બનાવવા માટે કયા નવા મુદ્દાઓ ઉમેરી શકાય અને કયા ઉદાહરણો મૂકી શકાય. 
                    ⚠️ ખાસ કડક સૂચના: સંદર્ભ વાંચન માટે માત્ર અને માત્ર ગુજરાત સરકારના પ્રમાણભૂત પુસ્તકો જ સૂચવવા. (ઉદાહરણ તરીકે: GCERT ના પાઠ્યપુસ્તકો, યુનિવર્સિટી ગ્રંથ નિર્માણ બોર્ડ, ભાષા નિયામકની કચેરીના પ્રકાશનો, 'ગુજરાત પાક્ષિક', 'યોજના' મેગેઝીન, અથવા ભારત સરકારના સત્તાવાર રિપોર્ટ). કોઈ પણ સંજોગોમાં ખાનગી ક્લાસીસ કે ખાનગી પ્રકાશનો (Private Publications) ના નામ ભૂલથી પણ આપવા નહીં.)
                    """
                    contents = [prompt]
