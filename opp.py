            ...
            with st.spinner("⏳ પેપરનું ડીપ ચેકિંગ ચાલુ છે..."):
                try:
                    if category == "સંપૂર્ણ પેપર (૧૦૦ ગુણ)":
                        ...
                        category_rules = """
                        ✅ **ખાસ સૂચના (સંપૂર્ણ પેપર માટે):** વિદ્યાર્થીએ આખું 100 માર્કનું પેપર અપલોડ કર્યું છે. તમારે દરેક પ્રશ્ન શોધીને તેનું અલગ-અલગ મૂલ્યાંકન કરવાનું છે. 
                        આંતરિક નિયમ: નિબંધમાં ૧૪ થી વધુ, ચર્ચાપત્ર/પત્રમાં ૬ થી વધુ અને સંક્ષેપમાં ૫ થી વધુ ગુણ આપવા નહીં.
                        """
                    elif category == "નિબંધ લેખન":
                        total_marks = 20
                        max_marks_allowed = 14
                        expected_words = "૨૫૦ થી ૩૦૦ શબ્દો"
                        category_rules = """✅ હકારાત્મક ગુણ: પ્રસ્તાવના/ઉપસંહાર, વિષયવસ્તુ/ઊંડાણ, મૌલિકતા, ભાષાકીય શુદ્ધિ."""
                    elif category == "ચર્ચાપત્ર":
                        total_marks = 10
                        max_marks_allowed = 6
                        expected_words = "આશરે ૨૦૦ શબ્દો"
                        category_rules = """✅ હકારાત્મક ગુણ: ફોર્મેટ, તટસ્થ રજૂઆત, રચનાત્મક સૂચનો, ઔપચારિક ભાષા."""
                    elif category == "પત્ર લેખન":
                        total_marks = 10
                        max_marks_allowed = 6
                        expected_words = "૧૫૦ થી ૨૦૦ શબ્દો"
                        category_rules = """✅ હકારાત્મક ગુણ: સત્તાવાર ફોર્મેટ, સચોટ વિષયવસ્તુ, સત્તાવાર શબ્દાવલિ."""
                    elif category == "સંક્ષેપીકરણ":
                        total_marks = 10
                        max_marks_allowed = 5
                        expected_words = "મૂળ ફકરાનો ૧/૩ (ત્રીજો) ભાગ"
                        category_rules = """✅ હકારાત્મક ગુણ: યોગ્ય શીર્ષક, મૂળ વિચારની જાળવણી, મૌલિકતા."""
                    else: # વ્યાકરણ
                        total_marks = 20
                        max_marks_allowed = 20
                        expected_words = "શબ્દમર્યાદા લાગુ પડતી નથી"
                        category_rules = """✅ નિયમ: દરેક પ્રશ્નનો ૧ ગુણ. સહેજ પણ ભૂલ હોય તો સીધો ૦ (ઝીરો) ગુણ."""
                    ...
                    (એક સુંદર ટેબલ બનાવો. તેમાં માત્ર 'કુલ ગુણ' અને 'મેળવેલ ગુણ' જ દર્શાવવા. 'મહત્તમ આપી શકાય તેવા ગુણ' એવો કોઈ ઉલ્લેખ ભૂલથી પણ કરવો નહીં.)
